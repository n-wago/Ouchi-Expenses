...
- **OCR文字起こし**: Google Cloud Vision APIを使用した超高精度な日本語テキスト抽出：95%+精度
...
├── services/
│   ├── __init__.py
│   ├── ocr_service.py          # OCR機能（Google Cloud Vision API）
...
**注**: Google Cloud Vision APIを使用します。詳細は設定してください。[GOOGLE_VISION_SETUP.md](GOOGLE_VISION_SETUP.md) を参照してください。
